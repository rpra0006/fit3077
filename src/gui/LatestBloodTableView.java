...
public class LatestBloodTableView extends TableView {
	...
	private class BloodPressureCellRenderer extends DefaultTableCellRenderer {
		/*
	...
	private void setAverageHighlighting() {
		this.table.getColumnModel().getColumn(1).setCellRenderer(new BloodPressureCellRenderer());
	}
